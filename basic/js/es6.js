...
// // map 메서드를 사용하여 각 맥주의 이름을 전체대문자 형태로 바꾸어보세요
...
// // 3. 매개변수 구조분해할당
// // 객체의 속성을 각 매개변수에 간단한 방법으로 할당할 수 있다
...
// // 구조분해할당 문법을 이용하여 각 맥주를 변수에 할당해보세요
...
// // 재입고
// var updatedIrishBeers = { ...irishBeer, available: true };

// consoele.log(updatedIrishBeers);



// 치즈가 삼선동으로 입양되었습니다
// home 속성을 스프레드 연산자를 활용해서 업데이트 해보세요
...
// 없는 속성은 추가되고, 있는 속성은 수정된다
var updatedCat = { ...cat, hone: "삼선동", color: "베이지" }; 
...
/*
     ...
     1. 프로미스 객체 생성
     두 개의 매개변수(콜백)을 가진 콜백을 생성자함수에 전달한다

     - 첫 번째 매개변수(resolve): 작업이 성공했을 경우 호출된다
     - 두 번째 매개변수(rejected): 작업이 실패했을 경우 호출된다
